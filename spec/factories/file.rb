...
FactoryGirl.define do
  factory :file, class: ActionDispatch::Http::UploadedFile do
    ...
    factory :image_file do
      ...
      factory :legacy_upload do
        tempfile File.new("#{Rails.root}/spec/fixtures/legacy.png")
      end
    end
    ...
    factory :oddball_file1 do
      tempfile File.new("#{Rails.root}/spec/fixtures/TIL.png")
      filename "til.png"
      content_type "image/png"
    end
